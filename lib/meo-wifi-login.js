...
var meoWifiLogoff = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    ...
    var _yield$axios$get, data, status, request, meoResponse;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            meoResponse = JSON.parse(data.substring(0, data.length - 2).replace('foo(', ''));
...
var meoWifiLogin = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(username, password, ip) {
    ...
    var cryptoPassword, _yield$axios$get2, data, status, request, meoResponse, message, returnedIP;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            request = _yield$axios$get2.request;
            meoResponse = JSON.parse(data.substring(0, data.length - 2).replace('foo(', ''));
            message = '';
            returnedIP = ip;
