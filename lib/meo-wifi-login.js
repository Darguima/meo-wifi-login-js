...
var meoWifiLogoff = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var _request$res;

    var _yield$axios$get$then, meoResponse, status, request;
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _axios["default"].get('https://servicoswifi.apps.meo.pt/HotspotConnection.svc/Logoff', {
              params: {
                callback: 'foo'
              }
            }).then(function (res) {
              return {
                meoResponse: JSON.parse(res.data.substring(0, res.data.length - 2).replace('foo(', '')),
                status: res.status,
                request: res.request
              };
            })["catch"](function (e) {
              return {
                ...
                status: 0,
                request: {
                  responseURL: 'https://servicoswifi.apps.meo.pt/HotspotConnection.svc/Login/ ...'
                }
              };
            });
          ...
          case 2:
            ...
            meoResponse = _yield$axios$get$then.meoResponse;
            status = _yield$axios$get$then.status;
            request = _yield$axios$get$then.request;
            return _context.abrupt("return", {
              success: meoResponse,
              statusCode: status,
              url: ((_request$res = request.res) === null || _request$res === void 0 ? void 0 : _request$res.responseUrl) || request.responseURL || ''
            });
...
var meoWifiLogin = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(username, password, ip) {
    var _request$res2;

    var cryptoPassword, _yield$axios$get$then2, meoResponse, status, request, message, returnedIP;

    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            cryptoPassword = encryptPassword(password, ip); // https://servicoswifi.apps.meo.pt/HotspotConnection.svc/Login?username=${username}&password=${cryptoPassword}&navigatorLang=pt&callback=foo

            _context2.next = 3;
            return _axios["default"].get('https://servicoswifi.apps.meo.pt/HotspotConnection.svc/Login', {
              params: {
                username: username,
          ...
          case 3:
            ...
            meoResponse = _yield$axios$get$then2.meoResponse;
            status = _yield$axios$get$then2.status;
            request = _yield$axios$get$then2.request;
            message = '';
            returnedIP = ip;
            ...
            return _context2.abrupt("return", {
              ...
              message: message,
              statusCode: status,
              url: ((_request$res2 = request.res) === null || _request$res2 === void 0 ? void 0 : _request$res2.responseUrl) || request.responseURL || '',
              returnedIP: returnedIP,
  ...
  return function meoWifiLogin(_x, _x2, _x3) {
